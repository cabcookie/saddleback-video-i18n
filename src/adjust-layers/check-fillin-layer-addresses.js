// TODO Every function should have an error handling gh:3 id:42

function checkFillinLayerAddresses(text, textLayer, delimiter) {
    ...
    for (var i = 1, tl = textAry.length; i < tl; i++) {
        ...
        while (newBl > lastBl) {
            ...
            // TODO:0 how can we handle centered text? id:0
        }
