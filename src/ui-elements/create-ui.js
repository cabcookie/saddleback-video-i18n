            ...
            if (pan != null) {
                ...
                "tab { \
                    ...
                    grpTimeControls: Group { \
                        ...
                        rewSecs10: IconButton { image:'./media_controls/rewSecs10.png', minimumSize:[35,22], preferredSize: [-1,22] }, \
                        rewSecs1: IconButton { image:'./media_controls/rewSecs1.png', minimumSize:[35,22], preferredSize: [-1,22] }, \
                        rewFrm1: IconButton { image:'./media_controls/rewFrm1.png', minimumSize:[35,22], preferredSize: [-1,22] }, \
                        forwFrm1: IconButton { image:'./media_controls/forwFrm1.png', minimumSize:[35,22], preferredSize: [-1,22] }, \
                        forwSecs1: IconButton { image:'./media_controls/forwSecs1.png', minimumSize:[35,22], preferredSize: [-1,22] }, \
                        forwSecs10: IconButton { image:'./media_controls/forwSecs10.png', minimumSize:[35,22], preferredSize: [-1,22] } \
                    }, \
                    titleSetInOut: StaticText { text:'Set In/Out Times' }, \
                    grpTemplate: Group { \
                        label: StaticText { text:'Select template:', minimumSize:[90,-1], maximumSize:[90,30], alignment:['left','center'] }, \
                        dropdown: DropDownList { minimumSize:[95,-1], alignment:['fill','center'] } \
                    }, \
