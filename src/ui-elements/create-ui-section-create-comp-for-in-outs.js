// TODO Every function should have an error handling gh:3 id:53

function createUISectionCreateCompForInOuts(panel, posY, stdWidth, titlePos, statusObj, statusColors) {
    var section;
    var templateNames = [];
